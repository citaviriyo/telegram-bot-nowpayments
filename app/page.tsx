        ...
        <div style={styles.container}>
          ...
          <div style={styles.longCard}>
            <p style={styles.pStrong}>
              <span style={styles.yellow}>Bukan untuk semua orang.</span> KOINITY
              dibuat bagi mereka yang ingin serius membangun posisi, bukan
              sekadar ikut tren dan berharap keberuntungan.
            </p>
            ...
            <p style={styles.p}>
              Masalahnya sering kali bukan soal kepintaran, melainkan karena
              tidak punya sistem dan lingkungan yang tepat.
            </p>
            ...
            <ul style={styles.ul}>
              ...
              <li style={styles.li}>
                bagaimana trader berpengalaman berpikir saat kondisi market
                berubah
              </li>
            </ul>

            <p style={styles.p}>
              Semua dibahas bersama komunitas yang satu frekuensi, dengan
              pendekatan yang lebih tenang, terukur, dan bertanggung jawab.
            </p>
            ...
            <div style={{ marginTop: 18 }}>
              ...
              <div style={styles.miniNote2}>
                {" "}
                👆 Silakan pilih menu di bot untuk mulai.
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" style={styles.sectionAlt}>
        <div style={styles.container}>
          ...
          <div style={styles.pricingWrap}>
            <div style={styles.priceCard}>
              ...
              <div style={styles.priceDesc}>
                Cocok buat mulai masuk komunitas & adaptasi sistem.
              </div>
              <a href={TG_BOT_URL} style={styles.priceBtnPrimary}>
                Buka Bot
              </a>
            </div>
            ...
            <div style={{ ...styles.priceCard, ...styles.priceCardFeatured }}>
              ...
              <div style={styles.priceDesc}>
                Lebih hemat, lebih stabil untuk ikut ritme market.
              </div>
              <a href={TG_BOT_URL} style={styles.priceBtnPrimary}>
                Buka Bot
              </a>
            ...
            <div style={styles.priceCard}>
              ...
              <div style={styles.priceDesc}>
                Value terbaik untuk growth & konsistensi jangka panjang.
              </div>
              <a href={TG_BOT_URL} style={styles.priceBtnPrimary}>
                Buka Bot
              </a>
          ...
          <div style={styles.noteBox}>
            <strong>Catatan:</strong> Setelah pembayaran sukses, akses VIP akan
          ...
          <div style={styles.faqGrid}>
            <details style={styles.faqItem}>
              ...
              <div style={styles.faqA}>
                Karena grup VIP private. Bot jadi pintu masuk resmi biar aman dan
                rapi.
              </div>
            </details>
            ...
            <details style={styles.faqItem}>
              ...
              <div style={styles.faqA}>
                Klik “Buka Bot”, ikuti instruksi, dan bot akan mengirim akses
                VIP.
              </div>
            </details>
          </div>
      ...
      <footer style={styles.footer}>
        <div style={styles.container}>
          <div style={styles.footerRow}>
            <div>
              ...
              <div style={styles.footerText}>
                VIP Membership via Telegram — belajar, diskusi, dan eksekusi
                bareng komunitas satu frekuensi.
              </div>
            </div>
            <div style={styles.footerLinks}>
              ...
              <a href={TG_BOT_URL} style={styles.footerLink}>
                koinity_bot
              </a>
            </div>
          </div>
          ...
          <div style={styles.footerBottom}>
            © <FooterYear /> Koinity. All rights reserved.
          </div>
        </div>
      </footer>
    </main>
